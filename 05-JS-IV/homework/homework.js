...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
  objeto [property] = null; //SE CONCATENA CON UN PUNTO (.) SI LA CLAVE/PROPIEDAD YA EXISTE. SINO,SE USA []
  return objeto
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  suma = producto.precio - (producto.precio * producto.porcentajeDeDescuento);
  return suma
}
return producto
}
